...
folder_path = 'C:\\spirit_data\\spirit_data_teste'
DELAY_PER_CAP = 6#random.uniform(20, 50)
DELAY_PER_PAGE = 3.5#random.uniform(6, 25)
...
def pega_texto(cap_content):
    ...
    while True:
        try: 
            cap_text = cap_content.find_all('p')[index_text].text
            texto_inteiro += cap_text
